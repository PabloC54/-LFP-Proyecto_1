...
Permite crear un conjunto donde ingresar datos con las mismas características. Uso: 

```sql
CREATE SET < ID >
```
### Cargar archivos en un set:
Permite meter varios archivos dentro de un set creado, especificando el nombre del set y el directorio relativo. Uso:
...
### Usar un set
Permite seleccionar un set especificando el nombre. Para los comandos de consulta es necesario seleccionar un set. Uso:
...
### Seleccionar datos
Permite seleccionar uno o más (o todos) atributos en los archivos AON del set cargado. Uso:
...
### Listar atributos
Permite listar los atributos de los registros cargados en el set. Uso:
...
Permite cambiar el color del texto en consola, especificando el color. Uso:
...
Permite mostrar el valor máximo especificado dentro de los registros cargados en el set seleccionado. Uso:
...
Permite mostrar el valor mínimo especificado dentro de los registros cargados en el set seleccionado. Uso:
...
### Sumar valores
Permite mostrar la suma del valor/valores (o todos los valores) del atributo especificado, dentro de los registros cargados en el set seleccionado. Uso:
...
### Contar valores
Permite mostrar la cuenta de veces que el atributo especificado aparece, dentro de los registros cargados en el set seleccionado. Uso:
...
### Reportar comando
Permite mostrar en un documento HTML (con el nombre especificado) la consulta del comando especificado. Uso:
...
### Cargar script
Permite ejecutar comandos escritos en un documento SIQL. Uso:
...
### Reportar tokens
Permite mostrar los lexemas encontrados en la ejecución del programa, junto a su token correspondiente. Uso:
